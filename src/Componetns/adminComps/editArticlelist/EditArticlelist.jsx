...
import styles from "./EditArticlelist.module.css"
...
function EditArticlelist({ list }) {
    ...
    function deleteHandler(id) {
        const updatedList = publications.filter(music => music.id !== id);
        setPublications(updatedList);
        setPublicationsMutable(updatedList)
    }
